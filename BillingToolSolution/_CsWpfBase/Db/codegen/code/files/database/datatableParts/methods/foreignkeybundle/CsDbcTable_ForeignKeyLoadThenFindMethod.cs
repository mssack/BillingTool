...
namespace CsWpfBase.Db.codegen.code.files.database.datatableParts.methods.foreignkeybundle
{
	...
	internal class CsDbcTable_ForeignKeyLoadThenFindMethod : CsDbCodeRelationFileTemplate
	{
		internal CsDbcTable_ForeignKeyLoadThenFindMethod(CsDbCodeRelation relation, CsDbcTable_ForeignKeyMethodBundle owner) : base(relation)
		{
			Owner = owner;
		}
		...
		[Key]
		public string Name => $"LoadThenFind_By_{FkColumn.Name}";

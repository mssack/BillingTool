...
using BillingToolDataAccessGenerator.DatabaseCreation;
using CsWpfBase.Db;
...
namespace BillingToolDataAccessGenerator
{
	/// <summary>Interaction logic for App.xaml</summary>
	public partial class App : Application
	{
		/// <summary>the relative path to the sample db inside project.</summary>
		public string SampleDatabaseFile => Path.Combine(new FileInfo("a").Directory.GoUpward_Until("_BillingTool.DataAccessGenerator").FullName, "BillingDatabase.sdf");
		/// <summary>the relative path to the target project folder.</summary>
		public string TargetProjectFolder => Path.Combine(new FileInfo("a").Directory.GoUpward_Until("BillingToolSolution").FullName, "BillingTool.DataAccess");
		...
		private void GenerateDatabaseClasses()
		{
			...
			codeBundle.SetPaths(Path.Combine(TargetProjectFolder, ""), "BillingToolDataAccess", Path.Combine(TargetProjectFolder, "BillingTool.DataAccess.csproj"));
			codeBundle.Write();
		}
	}

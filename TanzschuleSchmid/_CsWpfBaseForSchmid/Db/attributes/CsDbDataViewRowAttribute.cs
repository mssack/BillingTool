...
{
	/// <summary>The attribute for a row in a <see cref="CsDbViewRow"/>.</summary>
	public class CsDbViewRowAttribute : Attribute
	{
		...
		public string ToCode()
		{
			...
			if (!string.IsNullOrEmpty(ViewName))
				setters = $"{setters}ViewName = \"{ViewName}\", ";
